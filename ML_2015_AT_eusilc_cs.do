...
replace ml_eli = 1 		if country == "AT" & year == 2015 & gender == 1 ///
						& econ_status == 1 
replace ml_eli = 1 		if country == "AT" & year == 2015 & gender == 1 ///
...
replace ml_dur1 = 8 	if country == "AT" & year == 2015 & gender == 1 & ml_eli == 1

replace ml_dur2 = 8 	if country == "AT" & year == 2015 & gender == 1 & ml_eli == 1


* BENEFIT (monthly)
/*	-> 100% earnings, no ceiling
	-> marginally employed, self-insured: €8.80/day (not coded) 
	-> self-employed: €52.07/day	(not coded; LP&R 2015)		
	-> unemployed: 180% of unemployment benefits (not coded)
*/
	
replace ml_ben1 = earning 	if country == "AT" & year == 2015 & gender == 1 ///
...
foreach x in 1 2 {
	...
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "AT" & year == 2015
}
