...
/*	-> employed, self-employed: worked for at least 6 months (coded) during 10 months (not coded) before birth
	-> inactive women: maternity grantwards the 6 months
...
/*	-> parents can choose between 2 options for the whole parental leave:
	...
	-> joint right share: 21 weeks (remainder from 14 weeks reserved to mother and 14 weeks to father) 
			-> assigned to mother
*/

	* women
replace pl_dur = 21 		if country == "NO" & year == 2013 & pl_eli == 1 & gender == 1

	* single men
replace pl_dur = 21 		if country == "NO" & year == 2013 & pl_eli == 1 & gender == 2 & parstat == 1
...
/*	-> 100% earning
	-> ceiling: €64,464/year  
	-> maternity grant - €4,444 for the whole period (11 months)
*/
