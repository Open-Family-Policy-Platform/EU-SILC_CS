...
replace pl_eli = 0 		if pl_eli == . & country == "HR" & year == 2010
...
replace pl_ben2 = pl_ben1 		if country == "HR" & year == 2010 & pl_eli == 1
 ...
 foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "HR" & year == 2010
}

replace pl_dur = 0 	if pl_eli == 0 & country == "HR" & year == 2010
