...
*/
replace pl_eli = 1	 		if country == "EE" & year == 2010 
replace pl_eli = 0 			if pl_eli == . & country == "EE" & year == 2010


* DURATION (weeks)
/*	-> until child is 3 years old (parental benefit + childcare benefit)
...
* women	
replace pl_dur = (3*52) - ml_dur2 		if country == "EE" & year == 2010 ///
										& pl_eli == 1 & ml_eli == 1 & gender == 1
										
replace pl_dur = 18 * 4.3 		if country == "EE" & year == 2010 & pl_dur == . ///
								& pl_eli == 1 & inlist(econ_status,3,4) & gender == 1 

								
* single men										
replace pl_dur = 3*52 			if country == "EE" & year == 2010 ///
										& pl_eli == 1 & gender == 2 & parstat == 1
										
replace pl_dur = 18 * 4.3 		if country == "EE" & year == 2010 ///
								& pl_eli == 1 & gender == 2 & parstat == 1 ///
...
* women
replace pl_ben2 = earning  		if country == "EE" & year == 2010 & pl_eli == 1 ///
								& gender == 1 
...
* not eligible for maternity leave
	* women
replace pl_ben2 = 	220  		if country == "EE" & year == 2010 & pl_eli == 1 ///
								& inlist(econ_status,3,4) & gender == 1
	* single men
replace pl_ben2 = 220	 		if country == "EE" & year == 2010 & pl_eli == 1 ///
								& inlist(econ_status,3,4) & gender == 2 & parstat == 1							
...
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "EE" & year == 2010
}

replace pl_dur = 0 	if pl_eli == 0 & country == "EE" & year == 2010
