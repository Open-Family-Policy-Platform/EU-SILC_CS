...
*/
replace ml_eli = 1 			if country == "FI" & year == 2011 & gender == 1 
			
			
replace ml_eli = 0 			if ml_eli == . & country == "FI" & year == 2011 & gender == 1
...
replace ml_dur1 = 30/6 if country == "FI" & year == 2011 & gender == 1 & ml_eli == 1

replace ml_dur2 = (105-30)/6 if country == "FI" & year == 2011 & gender == 1 & ml_eli == 1
...
remaining 49 days:
	-> €22.13/day if unemployed or earnings are less than €9,447/year (income group 49a; LP&R 2011)
...
* Income group (IG) 56a
gen ml_ben56 = 22.13 * 21.7 		if country == "FI" & year == 2011 ///
									& gender == 1 & ml_eli == 1 ///
									& inlist(econ_status,3,4)


* IG 56b			
replace ml_ben56 = (earning * 0.9) 	if country == "FI" & year == 2011 ///
									& gender == 1 & ml_eli == 1 & ml_ben56 == . ///
									& (earning*12) <= 51510

* IG 56c			
gen ml_ben56a = ( 51510/12) * 0.9 	if country == "FI" & year == 2011 ///
									& gender == 1 & (earning*12) >  51510 ///
									& ml_eli == 1
									
gen ml_ben56b = (earning - (57183/12)) * 0.325 		if country == "FI" & year == 2011 ///
													& gender == 1 ///
													& (earning*12) >  51510 & ml_eli == 1
	
	
replace ml_ben56 = ml_ben56a + ml_ben56b 		if country == "FI" & year == 2011 ///
												& gender == 1 & ml_eli == 1 ///
												& ml_ben56 == . ///
												& (earning*12) >  51510 & ml_eli == 1
...
* IG 49a
gen ml_ben49 = 22.13 * 21.7 		if country == "FI" & year == 2011 & gender == 1 ///
									& ml_eli == 1 & inlist(econ_status,3,4)


replace ml_ben49 = 22.13 * 21.7 		if country == "FI" & year == 2011 & gender == 1 ///
									& ml_eli == 1 & (earning*12) < 10258

* IG 49b - annual earnings under €33,479
replace ml_ben49 = earning * 0.7 	if country == "FI" & year == 2011 & gender == 1 ///
									& ml_eli == 1 & ml_ben49 == . ///
									& inrange((earning*12),10258,36686)

* IG 49c - annual earnings between €33,480/year and € 51,510/year
gen ml_ben49a = (33480/12) * 0.7 	if country == "FI" & year == 2011 & gender == 1 ///
									& ml_eli == 1 & (earning*12) > 33480
			
gen ml_ben49b = (earning - (33480/12)) * 0.4 		if country == "FI" ///
									& year == 2011	& gender == 1 & ml_eli == 1 ///
...
replace ml_ben49 = ml_ben49a + ml_ben49c + ml_ben49d 		if country == "FI" ///
							& year == 2011	& gender == 1 & ml_eli == 1 & ml_ben49 == . ///
							& (earning*12) >  51510	
...
replace ml_ben2 = ml_ben56 		if country == "FI" & year == 2011 & gender == 1 & ml_eli == 1

foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "FI" & year == 2011
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "FI" & year == 2011
}
