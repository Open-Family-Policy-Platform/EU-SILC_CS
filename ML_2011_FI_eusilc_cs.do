...
* IG 56b			
gen ml_ben56 = (earning * 0.9) 	if country == "FI" & year == 2011 ///
									& gender == 1 & ml_eli == 1 & (earning*12) <= 51510
...
gen ml_ben56b = (earning - (51510/12)) * 0.325 		if country == "FI" & year == 2011 ///
													& gender == 1 ///
...
gen ml_ben49 = earning * 0.7 	if country == "FI" & year == 2011 & gender == 1 ///
									& ml_eli == 1 & inrange((earning*12),9447,33479)
