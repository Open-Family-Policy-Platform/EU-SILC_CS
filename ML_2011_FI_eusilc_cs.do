...
gen ml_ben1 = 22.13 * 21.7 		if country == "FI" & year == 2011 ///
									& gender == 1 & ml_eli == 1 ///
									& inlist(econ_status,3,4)

replace ml_ben1 = 22.13 * 21.7 		if country == "FI" & year == 2011 ///
									& gender == 1 & ml_eli == 1 ///
...
replace ml_ben1 = ((ml_ben56 * (56/105) ) + (ml_ben49 * (49/105)))		if country == "FI" ///
												& year == 2011	& gender == 1 & ml_eli == 1 & ml_ben1 == .
