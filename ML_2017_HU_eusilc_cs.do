...
replace ml_eli = 1 			if country == "HU" & year == 2017 & gender == 1 ///
							& inlist(econ_status,1,2) & (duremp+dursemp) >= 12
						

replace ml_eli = 0 			if ml_eli == . & country == "HU" & year == 2017 & gender == 1
...
replace ml_dur2 = 24-2 		if country == "HU" & year == 2017 & ml_eli == 1
...
replace ml_ben1 = 0.7*earning 		if country == "HU" & year == 2017 & ml_eli == 1
replace ml_ben2 = 0.7*earning 		if country == "HU" & year == 2017 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "HU" & year == 2017
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "HU" & year == 2017
}
