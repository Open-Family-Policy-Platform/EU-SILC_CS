...
/*	-> 100% earning
	...
	-> maximum:  €100,350  gross/year (LP&R 2011)		*/

* maternity benefit	
replace ml_ben1 = earning 		if country == "LU" & year == 2011 & ml_eli == 1 /// 
								& inlist(econ_status,1,2) & (duremp+dursemp) >= 6
								
replace ml_ben1 = 100350/12		if country == "LU" & year == 2011 & ml_eli == 1 ///
								& ml_ben1 >= 100350/12

* maternity allowance
replace ml_ben1 = 194.02 * 4.3 		if country == "LU" & year == 2011 & ml_eli == 1 & ml_ben1 == .
