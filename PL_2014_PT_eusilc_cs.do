...
replace pl_eli = 1 			if country == "PT" & year == 2014 & inlist(econ_status,1,2) ///
							& (duremp+dursemp) >= 6

							
replace pl_eli =  0			if pl_eli == . & country == "PT" & year == 2014
...
gen pl_init = (120 - 45)/5 		if country == "PT" & year == 2014
gen pl_exte = 3*4.3						if country == "PT" & year == 2014
	
* women
replace pl_dur = pl_init + pl_exte  	if country == "PT" & year == 2014 ///
										& pl_eli == 1 & gender == 1
...
* cohabiting men
replace pl_dur = pl_exte  			if country == "PT" & year == 2014 ///
										& pl_eli == 1 & gender == 2 
...
replace pl_ben1 =  (earning*(pl_init/pl_dur)) + ((earning*0.25)*(pl_exte/pl_dur))	///
												if country == "PT" & year == 2014 & pl_eli == 1 ///
												& gender == 1
												
replace pl_ben1 =  (419.22 * (pl_init/pl_dur)) + ((earning*0.25)*(pl_exte/pl_dur))		if country == "PT" & year == 2014 & pl_eli == 1	///
...
* cohabiting men
replace pl_ben1 = (earning*0.25)				if country == "PT" & year == 2014 & pl_eli == 1 ///
												& gender == 2 


* women												
replace pl_ben2 = earning 		if country == "PT" & year == 2014 & pl_eli == 1 & gender == 1

* single men
replace pl_ben2 = earning 		if country == "PT" & year == 2014 & pl_eli == 1 & gender == 2 & parstat == 1

* cohabiting men
replace pl_ben2 = (earning*0.25)				if country == "PT" & year == 2014 & pl_eli == 1 ///
												& gender == 2 


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "PT" & year == 2014
}

replace pl_dur = 0 	if pl_eli == 0 & country == "PT" & year == 2014
