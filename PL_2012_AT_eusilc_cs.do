...
*/
replace pl_eli = 1 	if country == "AT" & year == 2012 
replace pl_eli = 0 	if pl_eli == . & country == "AT" & year == 2012
...
* eligible for ML
replace pl_dur = 52 - ml_dur2 	if country == "AT" & year == 2012 & pl_eli == 1 ///
									& gender == 1 & ml_eli == 1

* not eligible for ML
replace pl_dur = 52 	if country == "AT" & year == 2012 & pl_eli == 1 ///
 ...
 ** employed 
replace pl_ben1 = 0.8 * earning 	if country == "AT" & year == 2012 & pl_eli == 1 /// 
									& econ_status == 1 & parstat == 1 
									
									

** self-employed, unemployed, inactive
replace pl_ben1 = 33 * 21.7 		if country == "AT" & year == 2012 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1		if country == "AT" & year == 2012 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "AT" & year == 2012
}

replace pl_dur = 0 	if pl_eli == 0 & country == "AT" & year == 2012
