...
replace ml_eli = 1 		if country == "BE" & year == 2018 & gender == 1 ///
						& inrange(econ_status,1,3) & (duremp+dursemp) >= 120/21.7 
replace ml_eli = 0 		if ml_eli == . & country == "BE" & year == 2018 & gender == 1
...
replace ml_dur1 = 1 	if country == "BE" & year == 2018 & gender == 1 ///
						& ml_eli == 1



			
replace ml_dur2 = 15-1 	if country == "BE" & year == 2018 & gender == 1 ///
						& ml_eli == 1
			
replace ml_dur2 = 12-1 	if country == "BE" & year == 2018 & gender == 1 ///
...
* BENEFIT (monthly)
/* 
	-> public sector: 100% earning (LP&R 2018)
	-> private sector:
...
foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "BE" & year == 2018
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "BE" & year == 2018
}
