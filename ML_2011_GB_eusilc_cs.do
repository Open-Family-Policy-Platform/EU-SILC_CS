...
replace ml_dur1 = 0 		if country == "GB" & year == 2011 & ml_eli == 1 & gender == 1
...
replace ml_ben2 = ml_bena 				if country == "GB" & year == 2011 & ml_eli == 1 ///
										&  ml_dur2 == 52
										
replace ml_ben2 = ml_ben1 				if country == "GB" & year == 2011 & ml_eli == 1 ///
										& ml_dur2 == 39							
...
foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "GB" & year == 2011 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "GB" & year == 2011 & ml_eli == 0
