...
replace pl_eli = 1 			if country == "FR" & year == 2011 & duremp >= 12 
replace pl_eli = 0 			if pl_eli == . & country == "FR" & year == 2011
...
/*	-> CLCA: €563.21/month 
	...
	-> COLCA: €805.39/month (not coded)
	
*/

replace pl_ben1 = 563.21 		if country == "FR" & year == 2011 & pl_eli == 1
replace pl_ben2 = pl_ben1 		if country == "FR" & year == 2011 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "FR" & year == 2011
}

 replace pl_dur = 0 	if pl_eli == 0 & country == "FR" & year == 2011
