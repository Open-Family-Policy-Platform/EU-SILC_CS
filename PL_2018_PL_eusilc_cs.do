...
replace pl_eli = 1 			if country == "PL" & year == 2018 & econ_status == 1
...
/*	-> proportional benefits: 
	...
	-> flat-rate benefit (not coded): €229/month
 */

* women
replace pl_ben1 = 0.8*earning			if country == "PL" & year == 2018 & pl_eli == 1 ///
										& pl_dur != . & gender == 1
							
* single men
replace pl_ben1 = 0.8*earning			if country == "PL" & year == 2018 & pl_eli == 1 ///
										& pl_dur != . & gender == 2 & parstat == 1
