...
* BENEFIT (monthly)
/*	-> 90% earning 
	-> minimum: statutory minimum wage => € 194.29/month (source: Eurostat, EARN_MW_CUR, 2015-S2)
	-> ceiling: average net renumeration =>  € 2,169.57/year (Eurostat: Annual net earnings, online data code: EARN_NT_NET)
...
replace ml_ben1 = 2169.57/12 				if country == "BG" & year == 2015 ///
										& gender == 1 & ml_eli == 1 & ml_ben1 >=  (2169.57/12)
