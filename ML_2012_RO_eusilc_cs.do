...
replace ml_eli = 0 			if ml_eli == . & country == "RO" & year == 2012 & gender == 1
...
replace ml_dur1 = 0 			if country == "RO" & year == 2012 & ml_eli == 1
...
foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "RO" & year == 2012
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "RO" & year == 2012
}
