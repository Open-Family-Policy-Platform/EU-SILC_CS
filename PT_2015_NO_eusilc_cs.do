...
replace pt_eli = 1 			if country == "NO" & year == 2015 & gender == 2 ///
...
replace pt_eli = 1 			if country == "NO" & year == 2015 & gender == 1 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
...
replace pt_eli = 0 			if pt_eli == . & country == "NO" & year == 2015 & gender == 2
...
replace pt_dur = 15 		if country == "NO" & year == 2015 & pt_eli == 1 
...
replace pt_ben1 = earning 		if country == "NO" & year == 2015 & pt_eli == 1

* ceiling
replace pt_ben1 = 61365/12			if country == "NO" & year == 2015 & pt_eli == 1 ///
									& pt_ben1 >= 61365/12

* minimum
replace pt_ben1 = 5018/11			if country == "NO" & year == 2015 & pt_eli == 1 ///
									& pt_ben1 < 5018/11


replace pt_ben2 = pt_ben1		if country == "NO" & year == 2015 & pt_eli == 1
...
foreach x in 1 2 {
	replace pt_ben`x' = 0 	if country == "NO" & year == 2015 & pt_eli == 0
}

replace pt_dur = 0 		if country == "NO" & year == 2015 & pt_eli == 0 
