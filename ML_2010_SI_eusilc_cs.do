...
replace ml_eli = 1 			if country == "SI" & year == 2010 & gender == 1 ///
							& inlist(econ_status,1,2) 
replace ml_eli = 1 			if country == "SI" & year == 2010 & gender == 1 ///
							& inlist(econ_status,3,4) & (duremp + dursemp) >= 12

* single men
replace ml_eli = 1 			if country == "SI" & year == 2010 & gender == 2 ///
							& inlist(econ_status,1,2) & parstat == 1
replace ml_eli = 1 			if country == "SI" & year == 2010 & gender == 2 ///
							& inlist(econ_status,3,4) & (duremp+dursemp) >= 12 & parstat == 1
							
replace ml_eli = 0 			if ml_eli == . & country == "SI" & year == 2010 & gender == 1
...
replace ml_dur1 = 28/7 			if country == "SI" & year == 2010 & ml_eli == 1
...
replace ml_ben1 = earning 		if country == "SI" & year == 2010 & ml_eli == 1 ///
								& inlist(econ_status,1,2)	
replace ml_ben1 = 404 			if country == "SI" & year == 2010 & ml_eli == 1 ///
								& inlist(econ_status,1,2) & ml_ben1 < 404
					

replace ml_ben2 = ml_ben1 		if country == "SI" & year == 2010 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "SI" & year == 2010
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "SI" & year == 2010
}
