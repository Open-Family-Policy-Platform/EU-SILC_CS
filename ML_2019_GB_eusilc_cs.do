...
replace ml_ben1 = (0.9 * earning) * ((6+33)/52) 		if country == "GB" & year == 2019 & ml_eli == 1 ///
														& econ_status == 1 & duremp >= 26/4.3 ///
														& (earning/4.3) >= 132 & gender == 1


	* above ceiling
replace ml_ben1 = ((0.9 * earning) * (6/52)) + ((166 * 4.3) * (33/52)) 	if country == "GB" & year == 2019 ///
																		& ml_eli == 1 & (0.9*earning) >= (166*4.3)
...
replace ml_ben1 = 166 * 4.3				if country == "GB" & year == 2019 & ml_eli == 1 ///
										& inlist(econ_status,1,2) & ml_dur2 == . ///
										& (earning/4.3) >= 34 & (earning/4.3) < 132 & gender == 1 & (0.9*earning) >= (166*4.3)
...
replace ml_ben2 = ml_ben1 				if country == "GB" & year == 2019 & ml_eli == 1 ///
										& ml_dur2 == 39							
