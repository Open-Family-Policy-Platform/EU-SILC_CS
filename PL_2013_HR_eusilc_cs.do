...
/*	-> employed/self-employed: 
		-> 1st and 2nd child:
			-> 4 months/parent/child (MISSOC 1/7/2013)
...
replace pl_dur = 3*4.3 		if country == "HR" & year == 2013 & pl_eli == 1 ///
...
replace pl_dur = (3*52) - ml_dur2 		if country == "HR" & year == 2013 & pl_eli == 1 ///
										& pl_dur == . & childc > 2 & gender == 1
...
/*	-> Employed & self-employd: 
		-> first 6 months:
			-> 100% 
			-> ceiling: €530/month (MISSOC 1/7/2013)
		-> after:
			-> 70%
			-> ceiling: €530/month (MISSOC 1/7/2013)
...
replace pl_ben1 = 530 			if country == "HR" & year == 2013 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & pl_ben1 > 530
						
replace pl_ben1 = 309 			if country == "HR" & year == 2013 & pl_eli == 1 ///
								& pl_ben1 == . & pl_eli == 1
