...
replace ml_eli = 1 			if country == "PL" & year == 2014 & gender == 1 ///
							& econ_status == 1
replace ml_eli = 0 			if ml_eli == . & country == "PL" & year == 2014 & gender == 1
...
replace ml_dur2 = 26 		if country == "PL" & year == 2014 & ml_eli == 1
...
foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "PL" & year == 2014
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "PL" & year == 2014
}
