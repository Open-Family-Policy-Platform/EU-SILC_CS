...
/*	-> employed/self-employed: 
		-> 1st and 2nd child:
			-> 4 months/parent/child (MISSOC 1/7/2016)
...
replace pl_dur = 3*4.3 		if country == "HR" & year == 2016 & pl_eli == 1 ///
							& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 ///
							& childc <= 2
						
replace pl_dur = 15/4.3 		if country == "HR" & year == 2016 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 ///
								& childc > 2 
						
replace pl_dur = 6*4.3 		if country == "HR" & year == 2016 & pl_eli == 1 ///
							& pl_dur == . & childc <= 2 & gender == 1
						
replace pl_dur = (3*52) - ml_dur2 		if country == "HR" & year == 2016 & pl_eli == 1 ///
										& pl_dur == . & childc > 2 & gender == 1
...
/*	-> Employed & self-employd: 
		-> <= 2 children:
			-> first 6 months:
				-> 100% 
				-> ceiling: €353/month (MISSOC 1/7/2016)
			-> after:
				-> 70%
				-> ceiling: €353/month (MISSOC 1/7/2016)
...
replace pl_ben1 = 353 			if country == "HR" & year == 2016 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & pl_ben1 > 530 ///
								& childc <= 2

								
* for 3+ children
replace pl_ben1 = ((earning * (6/30)) + (221 * 24)) / 30 		if country == "HR" & year == 2016 & pl_eli == 1 ///
																& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & gender == 1 ///
																& childc > 2
								
replace pl_ben1 = ((353 * 6) + (221 * 24)) / 30			if country == "HR" & year == 2016 & pl_eli == 1 ///
														& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & pl_ben1 > 530 ///
														& childc > 2
								
								
* non-working								
replace pl_ben1 = 221 			if country == "HR" & year == 2016 & pl_eli == 1 ///
								& pl_ben1 == . & pl_eli == 1
						
						
						
replace pl_ben2 = pl_ben1   	if country == "HR" & year == 2016 & pl_eli == 1 
replace pl_ben2 = earning 		if country == "HR" & year == 2016 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & gender == 1 ///
								& childc > 2
replace pl_ben2 = 353 			if country == "HR" & year == 2016 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & (duremp+dursemp) >= 12 & pl_ben1 > 530 ///
								& childc > 2		
