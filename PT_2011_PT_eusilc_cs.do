...
replace pt_eli = 1 		if country == "PT" & year == 2011 & gender == 2 ///
...
replace pt_dur = 20/5 	if country == "PT" & year == 2011 & pt_eli == 1
...
replace pt_ben1 = earning  	if country == "PT" & year == 2011 & pt_eli == 1

replace pt_ben1 = 419.22  	if country == "PT" & year == 2011 & pt_eli == 1 ///
							& pt_ben1 < 419.22

replace pt_ben2 = pt_ben1 	if country == "PT" & year == 2011 & pt_eli == 1


foreach x in 1 2 {
	replace pt_ben`x' = 0 	if pt_eli == 0 & country == "PT" & year == 2011
}

replace pt_dur = 0 if pt_eli == 0 & country == "PT" & year == 2011
