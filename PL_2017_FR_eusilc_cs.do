...
replace pl_eli = 1 			if country == "FR" & year == 2017 & duremp >= 12
replace pl_eli = 0 			if pl_eli == . & country == "FR" & year == 2017
...
* BENEFIT (monthly)
/*	-> PreParE: €392.09/month for full-time leave
	-> COLCA: €640.88/month (not coded)
*/

replace pl_ben1 = 392.09 		if country == "FR" & year == 2017 & pl_eli == 1
replace pl_ben2 = pl_ben1 		if country == "FR" & year == 2017 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "FR" & year == 2017
}

 replace pl_dur = 0 	if pl_eli == 0 & country == "FR" & year == 2017
