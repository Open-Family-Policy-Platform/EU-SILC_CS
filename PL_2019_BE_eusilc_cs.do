...
/*	-> private sector: employees, 12 months (coded) of employment in last 15 months with the same employer (not 
	...
	-> same-sex couples have the same rights (LP&R 2019)
*/
...
/*	
	-> 	the amoount of benefits vary depending on whether the parent is a single parent,
		...
		above or below 50 years old. (MISSOC 2019)
	...
	-> 	full-time work interruption - single parent: €1,313.48/month
	
	-> 	half-time work interruption: €417.44/month
	-> 	half-time work interruption - single parent: €656.74/month
