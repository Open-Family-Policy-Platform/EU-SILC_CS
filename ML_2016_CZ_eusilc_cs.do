...
replace ml_dur2 = 28-6 	if country == "CZ" & year == 2016 & gender == 1 & ml_eli == 1
...
replace ml_ben1 = (dab*0.7) * 21.7 		if country == "CZ" & year == 2016 & gender == 1 & ml_eli == 1
replace ml_ben1 = 41*21.7 				if country == "CZ" & year == 2016 & gender == 1 ///
										& ml_eli == 1 & ml_ben1 >= 41*21.7


replace ml_ben2 = ml_ben1 		if country == "CZ" & year == 2016 & gender == 1 & ml_eli == 1
