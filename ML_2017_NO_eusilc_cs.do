...
replace ml_eli = 1 			if country == "NO" & year == 2017 & gender == 1 ///
...
replace ml_eli = 1 			if country == "NO" & year == 2017 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
...
replace ml_eli = 0 			if ml_eli == . & country == "NO" & year == 2017 & gender == 1
...
replace ml_dur1 = 3 		if country == "NO" & year == 2017 & ml_eli == 1 & gender == 1

* both partners are eligible
replace ml_dur2 = 15-3 		if country == "NO" & year == 2017 & ml_eli == 1 & gender == 1 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) >= 6

* only man is eligible
replace ml_dur2 = 6 		if country == "NO" & year == 2017 & gender == 2 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6

* single man
replace ml_dur2 = 12		if country == "NO" & year == 2017 & gender == 2 ///
							& (duremp + dursemp) >= 6  & parstat == 1
...
replace ml_ben1 = earning 		if country == "NO" & year == 2017 & ml_eli == 1
replace ml_ben1 = 5113			if country == "NO" & year == 2017 & ml_eli == 1 ///
								& ml_ben1 >= 5113
replace ml_ben1 = 605			if country == "NO" & year == 2017 & ml_eli == 1 ///
								& ml_ben1 < 605


replace ml_ben2 = ml_ben1 		if country == "NO" & year == 2017 & ml_eli == 1


foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "NO" & year == 2017 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "NO" & year == 2017 & ml_eli == 0
