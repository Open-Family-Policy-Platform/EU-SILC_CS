...
replace ml_eli = 1 			if country == "LV" & year == 2020 & gender == 1 ///
							& inlist(econ_status,1,2) 

* single men
replace ml_eli = 1 			if country == "LV" & year == 2020 & gender == 2 ///
							& inlist(econ_status,1,2) & parstat == 1
							
replace ml_eli = 0 			if ml_eli == . & country == "LV" & year == 2020 & gender == 1
...
replace ml_dur1 = 2 		if country == "LV" & year == 2020 & ml_eli == 1
...
replace ml_ben1 = 0.8*earning 		if country == "LV" & year == 2020 & ml_eli == 1
replace ml_ben2 = ml_ben1 			if country == "LV" & year == 2020 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "LV" & year == 2020
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "LV" & year == 2020
}
