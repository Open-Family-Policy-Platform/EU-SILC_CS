...
replace pl_eli = 1 			if country == "PL" & year == 2020 & econ_status == 1
replace pl_eli = 0			if pl_eli == . & country == "PL" & year == 2020
...
*/
	...
	* women
replace pl_dur = 32 		if country == "PL" & year == 2020 & pl_eli == 1 ///
							& gender == 1 
...
/*	-> proportional benefits: 
		- woman choose 100% ML benefit: 100% earning for 6 weeks, 60% for 24 weeks (LP&R 2020; not coded)
		- woman choose 80% ML benefit: 80% earning for the whole period (coded; LP&R 2020)
	-> flat-rate benefit (not coded): €224/month
 */
 
* women
replace pl_ben1 = 0.8*earning		if country == "PL" & year == 2020 & pl_eli == 1 ///
									& pl_dur != . & gender == 1 
...
replace pl_ben2 = pl_ben1				if country == "PL" & year == 2020 & pl_eli == 1 ///
										& pl_dur != . 

foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "PL" & year == 2020
}

replace pl_dur = 0 	if pl_eli == 0 & country == "PL" & year == 2020
