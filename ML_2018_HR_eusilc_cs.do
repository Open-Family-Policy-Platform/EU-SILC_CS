...
*/
replace ml_eli = 1 		if country == "HR" & year == 2018 & gender == 1 ///
						& inrange(econ_status,1,4) 
						
replace ml_eli = 0 		if ml_eli == . & country == "HR" & year == 2018 ///
						& gender == 1
...
replace ml_dur1 = 28/5 		if country == "HR" & year == 2018 & ml_eli == 1 ///
							& inlist(econ_status,1,2) & gender == 1
replace ml_dur1 = 0 		if country == "HR" & year == 2018 & ml_eli == 1 ///
							& inlist(econ_status,3,4) & gender == 1
							

replace ml_dur2 = 6*4.3 	if country == "HR" & year == 2018 & ml_eli == 1 & gender == 1
...
/*	-> employed, self-employed & insured for  12 consecutive months (coded) or for 18 non-consecutive
	...
	-> those who do not fulfill this requirement = €315/month (MISSOC 1/7/2018)	*/
...
foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "HR" & year == 2018
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "HR" & year == 2018
}
