...
replace ml_dur1 = 3 		if country == "FR" & year == 2015 & gender == 1 & ml_eli == 1

replace ml_dur2 = 16-3 		if country == "FR" & year == 2015 & gender == 1 ///
							& ml_eli == 1 & childc < 2
							
replace ml_dur2 = 26-3 		if country == "FR" & year == 2015 & gender == 1 ///
							& ml_eli == 1 & childc >= 2
