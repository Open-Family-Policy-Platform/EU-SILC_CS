...
/*	-> total: 105 calendar days
	...
	-> single father: 80 days (LP&R 2018)
*/
	
replace ml_dur1 = 0 			if country == "SI" & year == 2018 & ml_eli == 1

replace ml_dur2 = 105/7 		if country == "SI" & year == 2018 & ml_eli == 1 ///
								& gender == 1
replace ml_dur2 = 80/7			if country == "SI" & year == 2018 & ml_eli == 1 ///
								& gender == 2 & parstat == 1
...
/*	-> 100%
	...
	-> minimum: €323.55/month (LP&R 2018)		*/
	
replace ml_ben1 = earning 		if country == "SI" & year == 2018 & ml_eli == 1 ///
								& inlist(econ_status,1,2)	
replace ml_ben1 = 323.55 		if country == "SI" & year == 2018 & ml_eli == 1 ///
								& inlist(econ_status,1,2) & ml_ben1 < 323.55
replace ml_ben1 = 2863	 		if country == "SI" & year == 2018 & ml_eli == 1 ///
								& inlist(econ_status,1,2) & ml_ben1 >= 2863 
					

replace ml_ben2 = ml_ben1 		if country == "SI" & year == 2018 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "SI" & year == 2018
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "SI" & year == 2018
}
