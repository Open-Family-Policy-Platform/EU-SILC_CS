...
/*	-> all women are eligible for cash benefits (vary by economic status)
	-> single fathers are entitled to mother's share of leave (LP&R 2020)
*/


replace ml_eli = 1 			if country == "SE" & year == 2020 & gender == 1

* single men
replace ml_eli = 1 			if country == "SE" & year == 2020 & gender == 2 ///
							& parstat == 1

replace ml_eli = 0 			if ml_eli == . & country == "SE" & year == 2020 & gender == 1
...
replace ml_dur1 = 0 		if country == "SE" & year == 2020 & ml_eli == 1

replace ml_dur2 = 90/7 		if country == "SE" & year == 2020 & ml_eli == 1
...
replace ml_ben1 = 0.776*earning 		if country == "SE" & year == 2020 & ml_eli == 1 ///
										& (earning/30) >= 23.48
replace ml_ben1 = 23.48*30				if country == "SE" & year == 2020 & ml_eli == 1 ///
										& ml_ben1 == . 
replace ml_ben1 = 45142/12			if country == "SE" & year == 2020 & ml_eli == 1 ///
										& earning >= (45142/12)

									
replace ml_ben2 = ml_ben1 			if country == "SE" & year == 2020 & ml_eli == 1


foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "SE" & year == 2020 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "SE" & year == 2020 & ml_eli == 0
