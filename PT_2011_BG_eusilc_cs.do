...
replace pt_eli = 1 if country == "BG" & year == 2011 & gender == 2 ///
				& econ_status == 1 & duremp >= 12
replace pt_eli = 0 if pt_eli == . & country == "BG" & year == 2011 & gender == 2



* DURATION (weeks)
/*	-> 15 days */
replace pt_dur = 15/5 if country == "BG" & year == 2011 & pt_eli == 1
...
replace pt_dur = 0 if pt_eli == 0 & country == "BG" & year == 2011
