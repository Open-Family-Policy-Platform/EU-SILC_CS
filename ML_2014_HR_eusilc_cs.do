...
*/
replace ml_eli = 1 		if country == "HR" & year == 2014 & gender == 1 ///
						& inrange(econ_status,1,4) 
						
replace ml_eli = 0 		if ml_eli == . & country == "HR" & year == 2014 ///
						& gender == 1
...
replace ml_dur1 = 28/5 		if country == "HR" & year == 2014 & ml_eli == 1 ///
							& inlist(econ_status,1,2) & gender == 1
replace ml_dur1 = 0 		if country == "HR" & year == 2014 & ml_eli == 1 ///
							& inlist(econ_status,3,4) & gender == 1
							

replace ml_dur2 = 6*4.3 	if country == "HR" & year == 2014 & ml_eli == 1 & gender == 1
...
/*	-> employed, self-employed & insured for  12 consecutive months (coded) or for 18 non-consecutive
	...
	-> those who do not fulfill this requirement = €219.60/month (MISSOC 1/7/2014)	*/
	
replace ml_ben1 = earning 		if country == "HR" & year == 2014 & gender == 1 ///
								& ml_eli == 1 & (duremp+dursemp) >= 12 & earning != 0
replace ml_ben1 = 219.6			if country == "HR" & year == 2014 & gender == 1 ///
								& ml_eli == 1 & ml_ben1 == .
								


replace ml_ben2 = ml_ben1 		if country == "HR" & year == 2014 & gender == 1 & ml_eli == 1

foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "HR" & year == 2014
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "HR" & year == 2014
}
