...
* BENEFIT (monthly)
/*	-> 10 days: 80% earning
		- ceiling: €35,167/year - this is earning ceiling NOT benefit ceiling 
		- minimum: not specified, also not specified whether only for working parents => 
			assumed identical with the 60 days 
	-> 60 days: 80% earning
			- minimum: €20/day
			- ceiling: €46,889/year - this is an earning ceiling NOT benefit ceiling (LP&R 2011)
*/
...
replace pt_ben1 = ((0.80 * (35167/12)) * (10/(90+10))) + ((0.80 * earning) * (90/(90+10))) ///
										if country == "SE" & year == 2011 & pt_eli == 1 ///
										& inrange((earning*12),35167,46889)

replace pt_ben1 = ((0.80 * (35167/12)) * (10/(90+10)))	+ ((0.80 * (46889/12)) * (90/(90+10))) ///
											if country == "SE" & year == 2011 & pt_eli == 1 ///
											& earning > 46889/12
