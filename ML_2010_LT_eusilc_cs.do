...
replace ml_dur1 = 70/7 		if country == "LT" & year == 2010 & ml_eli == 1

replace ml_dur2 = 56/7 		if country == "LT" & year == 2010 & ml_eli == 1


* BENEFIT (monthly)
/*	-> 100% average earninngs, no ceiling  
	-> minimum: 1/3 of the insured income of the current year (contains data from 2018)
*/
