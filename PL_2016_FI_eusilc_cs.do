...
replace pl_eli = 0 			if pl_eli == . & country == "FI" & year == 2016
...
replace pl_dur = 158/21.7 		if country == "FI" & year == 2016 & pl_eli == 1 ///
								& gender == 1
...
replace pl_ben2 = pl_ben1 			if country == "FI" & year == 2016 & pl_eli == 1

foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "FI" & year == 2016
}

replace pl_dur = 0 	if pl_eli == 0 & country == "FI" & year == 2016
