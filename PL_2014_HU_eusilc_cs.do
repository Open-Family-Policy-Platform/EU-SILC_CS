...
/*	-> employed, self-employed compulsorily insured for at least 365 days (coded)
		...
		-> for 2 years: 70% earning
			-> ceiling: €460/month (MISSOC 2014; GYED)
	...
	-> female tertiary education students or women who completed at least 2 semesters
		...
		-> undergraduate, for 1 year: €329/monthly
		-> MA, PhD, for 1 year: €382/month
...
* GYES
gen pl_gyes = 92 		if country == "HU" & year == 2014 & pl_eli == 1
...
gen pl_gyed = 0.7*earning 		if country == "HU" & year == 2014 & pl_eli == 1 ///
								...
								& earning < 460 & gender == 1
							
replace pl_gyed = 460		 	if country == "HU" & year == 2014 & pl_eli == 1 ///
								& ml_eli == 1 & inlist(econ_status,1,2) ///
								& earning >= 460 & gender == 1
								
	* single men
replace pl_gyed = 0.7*earning 	if country == "HU" & year == 2014 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & earning < 460 ///
								& gender == 2 & parstat == 1
