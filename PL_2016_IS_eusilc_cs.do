...
replace pl_eli = 1 			if country == "IS" & year == 2016 
replace pl_eli =  0			if pl_eli == . & country == "IS" & year == 2016
...
*/
replace pl_dur = 3*4.3 		if country == "IS" & year == 2016 & pl_eli == 1 ///
							& gender == 1 
* single men							
replace pl_dur = 3*4.3		if country == "IS" & year == 2016 & pl_eli == 1 ///
							& gender == 2 & parstat == 1
...
replace pl_ben1 = 0.8*earning	 		if country == "IS" & year == 2016 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& gender == 1

replace pl_ben1 = 799	 				if country == "IS" & year == 2016 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pl_ben1 < 799 & gender == 1
										
replace pl_ben1 = 2677	 				if country == "IS" & year == 2016 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
...
replace pl_ben1 = 1108	 				if country == "IS" & year == 2016 & pl_eli == 1 ///
...
* the rest - women
replace pl_ben1 = 483					if country == "IS" & year == 2016 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1		if country == "IS" & year == 2016 & pl_eli == 1



foreach x in 1 2 {
	replace pl_ben`x' = 0 	if country == "IS" & year == 2016 & pl_eli == 0	
}

replace pl_dur = 0 	if country == "IS" & year == 2016 & pl_eli == 0
