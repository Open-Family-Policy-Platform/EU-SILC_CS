...
replace pl_eli = 1 			if country == "LV" & year == 2016 
replace pl_eli =  0			if pl_eli == . & country == "LV" & year == 2016
...
replace pl_dur =  52 - ml_dur2		if country == "LV" & year == 2016 & pl_eli == 1 ///
									& inlist(econ_status,1,2) & gender == 1
									
* women, unemployed or inactive									
replace pl_dur = 2*52				if country == "LV" & year == 2016 & pl_eli == 1 ///
...
replace pl_ben1 = 0.6* earning 		if country == "LV" & year == 2016 & pl_eli == 1 ///
									& inlist(econ_status,1,2) & gender == 1

* women, unemployed or inactive									
replace pl_ben1 = ((171*(18/24)) + (42.69*(6/24))) 	if country == "LV" & year == 2016 & pl_eli == 1 ///
													& inlist(econ_status,3,4) & gender == 1	
...
replace pl_ben2 = pl_ben1 			if country == "LV" & year == 2016 & pl_eli == 1 ///
									& inlist(econ_status,1,2) 
									
replace pl_ben2 = (171*(18/24))		if country == "LV" & year == 2016 & pl_eli == 1 ///
									& inlist(econ_status,3,4) 
									

					
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "LV" & year == 2016
}

replace pl_dur = 0 	if pl_eli == 0 & country == "LV" & year == 2016
