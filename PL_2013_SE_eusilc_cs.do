...
replace pl_dur = 180/7 		if country == "SE" & year == 2013 & pl_eli == 1 

	* single 
replace pl_dur = (180+180)/7	if country == "SE" & year == 2013 & parstat == 1
...
* minimum
replace pl_ben1 = (((26*30) * (135/30)) + ((21*30) *  (45/30))) / (180/30) ///
									if country == "SE" & year == 2013 & pl_eli == 1 ///
									& earning/30 < 26 & earning != 0 & pl_dur != . 

* ceiling
replace pl_ben1 = (((51116/12) * (135/30)) + (((19*30) *  (45/30)))) / (180/30)	///
									if country == "SE" & year == 2013 & pl_eli == 1 ///
