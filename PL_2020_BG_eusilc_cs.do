...
replace pl_eli = 1 	if country == "BG" & year == 2020 & gender == 1 & econ_status == 1 & duremp >= 12
replace pl_eli = 1 	if country == "BG" & year == 2020 & gender == 1 & econ_status == 1 & duremp < 12 & duremp != .
replace pl_eli = 1 	if country == "BG" & year == 2020 & gender == 1 & inrange(econ_status,2,4) & earning < 230

replace pl_eli = 0 	if pl_eli == . & country == "BG" & year == 2020 
...
replace pl_dur = (2*52) - ml_dur2 		if country == "BG" & year == 2020 & pl_eli == 1 ///
										& gender == 1 & econ_status == 1 & duremp >= 12 ///
										& ml_eli == 1
										
	* not fulfiling the employment requirement
replace pl_dur = 52 		if country == "BG" & year == 2020 & pl_eli == 1 ///
...
replace pl_ben1 = 194	 if country == "BG" & year == 2020 & pl_eli == 1 ///
						 & gender == 1 & econ_status == 1 & duremp >= 12

replace pl_ben1 = 51	 if country == "BG" & year == 2020 & pl_eli == 1 ///
						 & gender == 1 & pl_ben1 == . & pl_eli == 1 


replace pl_ben2 = pl_ben1 	if country == "BG" & year == 2020 & pl_eli == 1 ///
							& gender == 1

							
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "BG" & year == 2020
}

replace pl_dur = 0 	if pl_eli == 0 & country == "BG" & year == 2020
