...
* BENEFIT (monthly)
/*	-> 90% earning 
	--> minimum: statutory minimum wage; €194.29 (source: Eurostat, Minimum wages, code: EARN_MW_CUR) 
...
* minimum
replace pt_ben1 = (194.29 * (15/21.7)) + (earning * ((21.7-15)/21.7)) 	if country == "BG" & year == 2015 ///
								& pt_eli == 1 & ((earning * 0.9) * (15/21.7)) < 194.29

* maximum 
replace pt_ben1 = ((2169.57/12) * (15/21.7)) + (earning * ((21.7-15)/21.7)) 	if country == "BG" & year == 2015 ///
								& pt_eli == 1 & (earning * 0.9) >= (2169.57/12)
