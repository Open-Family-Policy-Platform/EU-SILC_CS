...
/*	No statutory entitlement to paternity leave.
	...
	There is a 'Parental leave bonus for fathers' (MISSOC 2018)/'Family-time bonus' 
...
/*
	...
	-> does not ensure job protection! (LP&R 2018)
*/

replace pt_eli = 1 		if country == "AT" & year == 2018 & gender == 2 & econ_status == 1
replace pt_eli = 0 		if country == "AT" & year == 2018 & gender == 2 & pt_eli == .


* DURATION (weeks)
/* 	-> father can choose between 28-31 days (longest coded)
*/
replace pt_dur = 31/5	 if country == "AT" & year == 2018 & gender == 2


* BENEFIT (monthly)
/* 	-> €22.60/day 
*/
replace pt_ben1 = 22.6 * 5	 if country == "AT" & year == 2018 & gender == 2
replace pt_ben2 = pt_ben1	 if country == "AT" & year == 2018 & gender == 2
