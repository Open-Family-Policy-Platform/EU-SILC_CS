...
gen pl_init = (120 - 45)/5 		if country == "PT" & year == 2019
...
* cohabiting men
replace pl_dur = pl_exte  			if country == "PT" & year == 2019 ///
										& pl_eli == 1 & gender == 2 
...
replace pl_ben1 =  (435.76 * (pl_init/pl_dur)) + ((earning*0.25)*(pl_exte/pl_dur))		if country == "PT" & year == 2019 & pl_eli == 1	///
																						& earning < 435.76 & gender == 1
...
replace pl_ben1 =  (435.76 * (pl_init/pl_dur)) + ((earning*0.25)*(pl_exte/pl_dur))		if country == "PT" & year == 2019 & pl_eli == 1	///
																						& earning < 435.76 & gender == 2 & parstat == 1
								

* cohabiting men
replace pl_ben1 = (earning*0.25)				if country == "PT" & year == 2019 & pl_eli == 1 ///
												& gender == 2 


* women												
replace pl_ben2 = earning 		if country == "PT" & year == 2019 & pl_eli == 1 & gender == 1

* single men
replace pl_ben2 = earning 		if country == "PT" & year == 2019 & pl_eli == 1 & gender == 2 & parstat == 1

* cohabiting men
replace pl_ben2 = (earning*0.25)				if country == "PT" & year == 2019 & pl_eli == 1 ///
												& gender == 2 
