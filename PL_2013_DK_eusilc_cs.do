...
replace pl_eli = 1	 		if country == "DK" & year == 2013 & inlist(econ_status,1,3) 

replace pl_eli = 1			if country == "DK" & year == 2013 & econ_status == 2 & dursemp >= 6
...
replace pl_ben1 = 537*4.3		if country == "DK" & year == 2013 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & earning/4.3 >= 537 ///
								& gender == 1
