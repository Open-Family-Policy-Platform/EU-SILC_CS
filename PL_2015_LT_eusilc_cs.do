...
replace pl_eli = 1 			if country == "LT" & year == 2015 & inlist(econ_status,1,2) ///
							& (duremp+dursemp) >= 12

							
replace pl_eli =  0			if pl_eli == . & country == "LT" & year == 2015
...
* women	
replace pl_dur = 52-ml_dur2 		if country == "LT" & year == 2015 & pl_eli == 1 ///
									& gender == 1

* single men
replace pl_dur = 52-pt_dur 			if country == "LT" & year == 2015 & pl_eli == 1 ///
									& gender == 2 & parstat == 1
...
/* 	-> choice of leave until child is 1: 100% (coded)
	...
	-> ceiling: €1,379/month (LP&R 2015)
*/

* women		
replace pl_ben1 = earning 		if country == "LT" & year == 2015 & pl_eli == 1 & gender == 1
...
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "LT" & year == 2015
}

replace pl_dur = 0 	if pl_eli == 0 & country == "LT" & year == 2015
