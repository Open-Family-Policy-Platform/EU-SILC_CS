...
/* 	-> choice of leave until child is 1: 100% (coded)
	...
	-> ceiling: €1,379/month (LP&R 2016)
*/

* women		
replace pl_ben1 = earning 		if country == "LT" & year == 2016 & pl_eli == 1 & gender == 1
								
replace pl_ben1 = 1379	 		if country == "LT" & year == 2016 & pl_eli == 1 ///
								& pl_ben1 >= 1379 & gender == 1

* single men
replace pl_ben1 = earning 		if country == "LT" & year == 2016 & pl_eli == 1 & gender == 2 & parstat == 1
