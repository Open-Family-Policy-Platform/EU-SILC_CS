...
replace pl_eli = 1 	if country == "BG" & year == 2014 & gender == 1
replace pl_eli = 0 	if pl_eli == . & country == "BG" & year == 2014 
...
replace pl_dur = (2*52) - ml_dur2 		if country == "BG" & year == 2014 & pl_eli == 1 ///
...
replace pl_ben1 =  174	 if country == "BG" & year == 2011 & pl_eli == 1 ///
						 & gender == 1 



replace pl_ben2 = pl_ben1 	if country == "BG" & year == 2014 & pl_eli == 1 ///
							& gender == 1

							
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "BG" & year == 2014
}

replace pl_dur = 0 	if pl_eli == 0 & country == "BG" & year == 2014
