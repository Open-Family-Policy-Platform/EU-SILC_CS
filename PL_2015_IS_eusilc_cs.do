...
* the rest - women
replace pl_ben1 = 412					if country == "IS" & year == 2015 & pl_eli == 1 ///
...
replace pl_ben1 = 682	 				if country == "IS" & year == 2015 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pl_ben1 < 682 & gender == 2 & parstat == 1
...
replace pl_ben1 = 945	 				if country == "IS" & year == 2015 & pl_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& pl_ben1 < 945 & gender == 2 & parstat == 1
