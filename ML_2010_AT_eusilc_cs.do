...
replace ml_eli = 0 		if ml_eli == . & country == "AT" & year == 2010 & gender == 1
...
replace ml_dur1 = 8 	if country == "AT" & year == 2010 & gender == 1 & ml_eli == 1

replace ml_dur2 = 8 	if country == "AT" & year == 2010 & gender == 1 & ml_eli == 1
...
replace ml_ben1 = earning 	if country == "AT" & year == 2010 & gender == 1 ///
							& ml_eli == 1 & econ_status == 1
								
				
replace ml_ben2 = ml_ben1 	if country == "AT" & year == 2010 & gender == 1 & ml_eli == 1
				
foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "AT" & year == 2010
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "AT" & year == 2010
}
