...
replace ml_eli = 1 		if country == "BG" & year == 2011 & gender == 1 ///
						& econ_status == 1 & duremp >= 12
					
						
replace ml_eli = 0 		if ml_eli == . & country == "BG" & year == 2011 & gender == 1
...
replace ml_dur1 = 45/5 			if country == "BG" & year == 2011 & gender == 1 & ml_eli == 1

replace ml_dur2 = (410-45)/7 	if country == "BG" & year == 2011 & gender == 1 & ml_eli == 1
...
replace ml_ben2 = ml_ben1 	if country == "BG" & year == 2011 & gender == 1 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "BG" & year == 2011
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "BG" & year == 2011
}
