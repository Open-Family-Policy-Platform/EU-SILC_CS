...
/*	-> eligible for earning related benefit: min. income €26/day for 240 calendar days before childbirth
		...
		- for 195 calendar days (includes 60 non-transferable leave): 
			...
			- minimum: €20/day
			- ceiling: € 46,889 for the duration of benefits
		- for 45 days: €20/day
	-> all others: €20/day
 */
...
replace pl_ben1 = (((0.80*earning) * (135/30)) + ((20*30) *  (45/30))) / (180/30)	///	
									if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning/30 >= 19 & pl_dur != . 

* minimum
replace pl_ben1 = (((20*30) * (135/30)) + ((20*30) *  (45/30))) / (180/30) ///
									if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning/30 < 20 & earning != 0 & pl_dur != . 

* ceiling
replace pl_ben1 = (((46889/12) * (135/30)) + (((20*30) *  (45/30)))) / (180/30)	///
									if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning*12 >= 46889 & pl_dur != . 
...
replace pl_ben2 = 46889/12			if country == "SE" & year == 2011 & pl_eli == 1 ///
									& earning*12 >= 46889 & pl_dur != .
