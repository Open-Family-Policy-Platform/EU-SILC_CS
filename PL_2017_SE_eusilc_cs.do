...
replace pl_dur = 150/7 		if country == "SE" & year == 2017 & pl_eli == 1 

	* single 
replace pl_dur = (150+150)/7	if country == "SE" & year == 2017 & parstat == 1
...
* all others									
replace pl_ben1 = 25.60*30				if country == "SE" & year == 2017 & pl_eli == 1 ///
									& earning == 0 & pl_dur != . 
...
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if country == "SE" & year == 2017 & pl_eli == 0
}

replace pl_dur = 0 	if country == "SE" & year == 2017 & pl_eli == 0
