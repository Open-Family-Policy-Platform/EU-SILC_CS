...
replace pl_eli = 1 			if country == "ES" & year == 2019 & inlist(econ_status,1,2)
replace pl_eli =  0			if pl_eli == . & country == "ES" & year == 2019
...
replace pl_dur = (3*52) - ml_dur2 		if country == "ES" & year == 2019 & pl_eli == 1 ///
										& gender == 1 & ml_eli == 1
...
replace pl_ben1 = 0 		if country == "ES" & year == 2019 & pl_eli == 1
...
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if country == "ES" & year == 2019 & pl_eli == 0
}

replace pl_dur = 0 	if country == "ES" & year == 2019 & pl_eli == 0
