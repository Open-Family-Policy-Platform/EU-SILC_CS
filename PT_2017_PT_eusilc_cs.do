...
replace pt_eli = 1 		if country == "PT" & year == 2017 & gender == 2 ///
						& inlist(econ_status,1,2) & duremp + dursemp >= 6
						
replace pt_eli = 0 		if pt_eli == . & country == "PT" & year == 2017 & gender == 2
...
replace pt_dur = 25/5 	if country == "PT" & year == 2017 & pt_eli == 1
...
replace pt_ben1 = earning  	if country == "PT" & year == 2017 & pt_eli == 1

replace pt_ben1 = 421.32  	if country == "PT" & year == 2017 & pt_eli == 1 ///
							& pt_ben1 < 421.32

replace pt_ben2 = pt_ben1 	if country == "PT" & year == 2017 & pt_eli == 1


foreach x in 1 2 {
	replace pt_ben`x' = 0 	if pt_eli == 0 & country == "PT" & year == 2017
}

replace pt_dur = 0 if pt_eli == 0 & country == "PT" & year == 2017
