/* PT_2015_EE_eusilc_cs */

* ESTONIA - 2015

* ELIGIBILITY
/*	-> employed (coded) fathers with permanent contract (MISSOC 01/07/2015; not coded) */ 

replace pt_eli = 1 		if country == "EE" & year == 2015 & gender == 2 ///
						& econ_status == 1
replace pt_eli = 0 		if pt_eli == . & country == "EE" & year == 2015
...
foreach x in 1 2 {
	replace pt_ben`x' = 0 	if pt_eli == 0 & country == "EE" & year == 2015
}

replace pt_dur = 0 if pt_eli == 0 & country == "EE" & year == 2015
