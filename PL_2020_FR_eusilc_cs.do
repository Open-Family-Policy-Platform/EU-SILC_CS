...
replace pl_dur = (2*52) - ml_dur2 		if country == "FR" & year == 2020 ///
										& pl_eli == 1 & gender == 1 & ml_eli == 1 ///
										& childc >= 1

* women with at least one child, not eligible for ML										
replace pl_dur = 2*52 			if country == "FR" & year == 2020 & gender == 1 ///
								& pl_eli == 1 & pl_dur == . & childc >= 1
										
* men, cohabiting, at least one child
replace pl_dur = 52	 					if country == "FR" & year == 2020 ///
										& pl_eli == 1 & gender == 2 & childc >= 1 ///
										& parstat == 2 & pl_dur == .
										
* single men, at least one child
replace pl_dur = 2*52	 				if country == "FR" & year == 2020 ///
										& pl_eli == 1 & gender == 2 & childc >= 1 ///
										& parstat == 1 & pl_dur == .
...
* BENEFIT (monthly)
/*	-> €398.40/month for full-time leave
	 
*/

replace pl_ben1 = 398.40		if country == "FR" & year == 2020 & pl_eli == 1
replace pl_ben2 = pl_ben1 		if country == "FR" & year == 2020 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "FR" & year == 2020
}

 replace pl_dur = 0 	if pl_eli == 0 & country == "FR" & year == 2020
