...
*/
replace pl_eli = 1 	if country == "AT" & year == 2016 
replace pl_eli = 0 	if pl_eli == . & country == "AT" & year == 2016
...
* employed   
	* eligible for ML
	* and cohabiting
replace pl_dur = 52 - ml_dur2 	if country == "AT" & year == 2016 & pl_eli == 1 ///
...
replace pl_dur = 52 - ml_dur2 	if country == "AT" & year == 2016 & pl_eli == 1 ///
	...
	* not eligible for ML
	* and cohabiting
replace pl_dur = 52 	if country == "AT" & year == 2016 & pl_eli == 1 ///
							& gender == 1 & (econ_status == 1 | p_econ_status == 1) ///
 ...
 ** not employed & single
replace pl_ben1 = 33 * 21.7	 	if country == "AT" & year == 2016 & pl_eli == 1 /// 
...
replace pl_ben1 = 0.8 * p_earning	if country == "AT" & year == 2016 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1		if country == "AT" & year == 2016 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "AT" & year == 2016
}

replace pl_dur = 0 	if pl_eli == 0 & country == "AT" & year == 2016
