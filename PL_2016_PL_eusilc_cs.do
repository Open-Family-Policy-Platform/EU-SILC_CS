...
replace pl_eli = 1 			if country == "PL" & year == 2016 & econ_status == 1
...
/*	-> proportional benefits: 
	...
	-> flat-rate benefit (not coded): €226/month
 */

* women
replace pl_ben1 = 0.8*earning			if country == "PL" & year == 2016 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1			if country == "PL" & year == 2016 & pl_eli == 1
