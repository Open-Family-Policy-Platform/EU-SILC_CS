...
replace pl_dur = 158/6 		if country == "FI" & year == 2012 & pl_eli == 1 ///
								& gender == 1
...
* WOMEN 
* IGa
replace pl_ben1 = 22.13 * 21.7 			if country == "FI" & year == 2012 & gender == 1 ///
										& pl_eli == 1 
									

* IGb
replace pl_ben1 = earning * 0.7 		if country == "FI" & year == 2012 & gender == 1 ///
										& pl_eli == 1 & inrange((earning*12),9447,33479)

									
* IGc 
gen pl_bena = (33480/12) * 0.7 		if country == "FI" & year == 2012 & gender == 1 ///
...
gen pl_benc = (51510/12) * 0.4			if country == "FI" & year == 2012	& gender == 1 ///
...
* SINGLE MEN
* IGa
replace pl_ben1 = 22.13 * 21.7 			if country == "FI" & year == 2012 & gender == 2 ///
										& pl_eli == 1 & parstat == 1
									

* IGb
replace pl_ben1 = earning * 0.7 		if country == "FI" & year == 2012 & gender == 2 ///
										& pl_eli == 1 & inrange((earning*12),9447,33479) ///
										 & parstat == 1

									
* IGc 
replace pl_bena = (33480/12) * 0.7 		if country == "FI" & year == 2012 & gender == 2 ///
...
replace pl_ben1 = pl_bena + pl_benb 		if country == "FI" ///
												& year == 2012	& gender == 2 ///
												& pl_eli == 1 & inrange((earning*12),33479,51510) ///
												& parstat == 1
...
replace pl_benc = (51510/12) * 0.4		if country == "FI" & year == 2012	& gender == 2 ///
...
replace pl_ben2 = pl_ben1 			if country == "FI" & year == 2012 & pl_eli == 1
foreach x in 1 2 {
