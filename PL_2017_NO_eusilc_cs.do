...
replace pl_eli = 0			if pl_eli == . & country == "NO" & year == 2017
...
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if country == "NO" & year == 2017 & pl_eli == 0	
}

replace pl_dur = 0 	if country == "NO" & year == 2017 & pl_eli == 0
