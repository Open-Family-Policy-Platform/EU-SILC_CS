...
*/
replace ml_eli = 1	 	if country == "DK" & year == 2016 & gender == 1 ///
...
replace ml_eli = 0 		if ml_eli == . & country == "DK" & year == 2016 & gender == 1



* DURATION (weeks)
/*	-> combined entitlement for mother and father (MISSOC 01/07/2016) covering 
		maternity, paternity and parental leave
	-> prenatal: 4 weeks
	-> postnatal: 14 weeks
*/
	
replace ml_dur1 = 4 	if country == "DK" & year == 2016 & ml_eli == 1

replace ml_dur2 = 14 	if country == "DK" & year == 2016 & ml_eli == 1
...
replace ml_ben1 = earning 		if country == "DK" & year == 2016 & ml_eli == 1 ///
								& inlist(econ_status,1,2) & earning < 562*4.3

replace ml_ben1 = 562*4.3		if country == "DK" & year == 2016 & ml_eli == 1 ///
								& inlist(econ_status,1,2) & ml_ben1 >= 562*4.3
								

replace ml_ben2 = ml_ben1 if country == "DK" & year == 2016 & ml_eli == 1


foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "DK" & year == 2016
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "DK" & year == 2016
}
