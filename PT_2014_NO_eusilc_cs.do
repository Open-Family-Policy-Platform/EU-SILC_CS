...
replace pt_eli = 1 			if country == "NO" & year == 2014 & gender == 1 ///
							& (duremp + dursemp) >= 6  & (p_duremp + p_dursemp) < 6
...
replace pt_dur = 15 		if country == "NO" & year == 2014 & pt_eli == 1 
...
* minimum
replace pt_ben1 = 4631/11			if country == "NO" & year == 2014 & pt_eli == 1 ///
									& pt_ben1 < 4631/11
