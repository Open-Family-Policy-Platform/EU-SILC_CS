...
replace ml_eli = 1 			if country == "PL" & year == 2020 & gender == 1 ///
							& econ_status == 1
replace ml_eli = 0 			if ml_eli == . & country == "PL" & year == 2020 & gender == 1
...
replace ml_dur1 = 0 		if country == "PL" & year == 2020 & ml_eli == 1

replace ml_dur2 = 20 		if country == "PL" & year == 2020 & ml_eli == 1
...
replace ml_ben1 = earning*0.8 		if country == "PL" & year == 2020 & ml_eli == 1
replace ml_ben1 = 224 				if country == "PL" & year == 2020 & ml_eli == 1 ///
									& ml_ben1 < 224

replace ml_ben2 = ml_ben1 			if country == "PL" & year == 2020 & ml_eli == 1						

foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "PL" & year == 2020
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "PL" & year == 2020
}
