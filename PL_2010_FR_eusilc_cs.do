...
replace pl_eli = 1 			if country == "FR" & year == 2010 & duremp >= 12
...
replace pl_dur = 6*4.3 						if country == "FR" & year == 2010 ///
...
foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "FR" & year == 2010
}

 replace pl_dur = 0 	if pl_eli == 0 & country == "FR" & year == 2010
