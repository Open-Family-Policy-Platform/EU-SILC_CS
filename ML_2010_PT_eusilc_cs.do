/* ML_2010_PT_eusilc_cs */

* PORTUGAL - 2010

* ELIGIBILITY
/*	-> pooled rights (i.e. individual and family rights to leave)
		- total leave: 120 or 150 calendar days (parents' choice)
		- ML refers to the leave reserved for mother (6 weeks compulsory leave)
...
*/
replace ml_dur1 = 0 		if country == "PT" & year == 2010 & ml_eli == 1

replace ml_dur2 = 6 		if country == "PT" & year == 2010 & ml_eli == 1
...
replace ml_ben1 = earning 		if country == "PT" & year == 2010 & ml_eli == 1
replace ml_ben1 = 419.22		if country == "PT" & year == 2010 & ml_eli == 1 ///
								& ml_ben1 < 419.22
								
replace ml_ben2 = ml_ben1 		if country == "PT" & year == 2010 & ml_eli == 1

foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "PT" & year == 2010
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "PT" & year == 2010
}
