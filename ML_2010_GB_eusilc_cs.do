...
replace ml_dur1 = 0 		if country == "GB" & year == 2010 & ml_eli == 1 & gender == 1

replace ml_dur2 = 52 		if country == "GB" & year == 2010 & ml_eli == 1 ///
							& econ_status == 1 & duremp >= 26/4.3 ///
							& (earning/4.3) >= 118 & gender == 1
							
replace ml_dur2 = 39		if country == "GB" & year == 2010 & ml_eli == 1 ///
...
foreach x in 1 2 {
	replace ml_dur`x' = 0 	if country == "GB" & year == 2010 & ml_eli == 0
	replace ml_ben`x' = 0 	if country == "GB" & year == 2010 & ml_eli == 0
