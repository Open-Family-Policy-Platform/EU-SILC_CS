...
* DURATION (weeks)
replace pt_dur = 0  	if country == "CZ" & year == 2017 & gender == 2 & pt_eli == 1 


* BENEFIT (monthly)

replace pt_ben1 = 0		if country == "CZ" & year == 2017 & pt_eli == 1

replace pt_ben2 = pt_ben1 	if country == "CZ" & year == 2017 & pt_eli == 1
