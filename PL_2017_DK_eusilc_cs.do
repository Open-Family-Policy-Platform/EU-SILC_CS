...
replace pl_eli = 1	 		if country == "DK" & year == 2017 & inlist(econ_status,1,3) 

replace pl_eli = 1			if country == "DK" & year == 2017 & econ_status == 2 & dursemp >= 6

replace pl_eli = 1	 		if country == "DK" & year == 2017 & pl031 == 6
							

replace pl_eli = 0 			if pl_eli == . & country == "DK" & year == 2017
...
* couples => to women	
replace pl_dur = 32 		if country == "DK" & year == 2017 & pl_eli == 1 & gender == 1

* single men
replace pl_dur = 32 		if country == "DK" & year == 2017 & pl_eli == 1 & gender == 2 ///
							& parstat == 1
...
replace pl_ben1 = earning 		if country == "DK" & year == 2017 & pl_eli == 1 ///
								& inlist(econ_status,1,2) & gender == 1

replace pl_ben1 = 571*4.3		if country == "DK" & year == 2017 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1 		if country == "DK" & year == 2017 & pl_eli == 1 ///
								& gender == 1

foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "DK" & year == 2017
}

replace pl_dur = 0 	if pl_eli == 0 & country == "DK" & year == 2017
