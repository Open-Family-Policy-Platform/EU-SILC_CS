...
replace ml_eli = 1 		if country == "BE" & year == 2015 & gender == 1 ///
						& inrange(econ_status,1,3) & (duremp+dursemp) >= 120/21.7
replace ml_eli = 0 		if ml_eli == . & country == "BE" & year == 2015 & gender == 1
...
replace ml_dur1 = 1 	if country == "BE" & year == 2015 & gender == 1 ///
						& ml_eli == 1



			
replace ml_dur2 = 15-1 	if country == "BE" & year == 2015 & gender == 1 ///
						& ml_eli == 1
			
replace ml_dur2 = 8-1 	if country == "BE" & year == 2015 & gender == 1 ///
...
replace ml_ben1 = (((((0.82*earning) / 4.3) * (30/5)) + (((0.75*earning)/4.3) * (15 - (30/5)))) / 15) * 4.3 /// 
						if country == "BE" & year == 2015 & gender == 1 ///
...
* self-employed
replace ml_ben1 = 440.5 * 4.3 		if country == "BE" & year == 2015 ///
...
foreach x in 1 2 {
    replace ml_dur`x' = 0 	if ml_eli == 0 & country == "BE" & year == 2015
	replace ml_ben`x' = 0 	if ml_eli == 0 & country == "BE" & year == 2015
}
