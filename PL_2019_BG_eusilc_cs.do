...
replace pl_eli = 1 	if country == "BG" & year == 2019 & gender == 1 & econ_status == 1 & duremp >= 12
replace pl_eli = 1 	if country == "BG" & year == 2019 & gender == 1 & econ_status == 1 & duremp < 12 & duremp != .
replace pl_eli = 1 	if country == "BG" & year == 2019 & gender == 1 & inrange(econ_status,2,4) & earning < 230
