...
replace pl_eli = 1 			if country == "ES" & year == 2016 & inlist(econ_status,1,2)
replace pl_eli =  0			if pl_eli == . & country == "ES" & year == 2016
...
replace pl_dur = (3*52) - ml_dur2 		if country == "ES" & year == 2016 & pl_eli == 1 ///
										& gender == 1 & ml_eli == 1

* single men										
replace pl_dur = (3*52) - pt_dur 		if country == "ES" & year == 2016 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1		if country == "ES" & year == 2016 & pl_eli == 1



foreach x in 1 2 {
	replace pl_ben`x' = 0 	if country == "ES" & year == 2016 & pl_eli == 0
}

replace pl_dur = 0 	if country == "ES" & year == 2016 & pl_eli == 0
