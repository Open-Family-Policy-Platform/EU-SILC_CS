...
gen pl_init = (150 - (6*5) - 15)/5 		if country == "PT" & year == 2017
...
replace pl_ben1 =  428.90		if country == "PT" & year == 2017 & pl_eli == 1	///
...
replace pl_ben2 = earning 		if country == "PT" & year == 2017 & pl_eli == 1
