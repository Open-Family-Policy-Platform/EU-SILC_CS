...
replace pt_eli = 1 		if country == "IS" & year == 2017 & gender == 2 

* single women
replace pt_eli = 1 		if country == "IS" & year == 2017 & gender == 1 ///
						& parstat == 1
replace pt_eli = 0 		if pt_eli == . & country == "IS" & year == 2017 & gender == 2
...
replace pt_dur = 3*4.3 	if country == "IS" & year == 2017 & pt_eli == 1 
...
/*	-> employed, self-employed: active for 6 months prior to birth
			...
			- 80% earning
			- ceiling: €4,257/month 
			- minimum: €1,007/month 	if worked between 25% and 49% FT (i.e. 10 and 19.6 hours/week)
					   €1,396/month 	if worked between 50% and 100% FT (i.e. more than 20 hours/week)
					   
	-> those not fulfilling the conditions: 
		- students: €1,398/month
		- working less than 25% FT: €609/month
*/

* employed, self-employed working 10-20 hours/week			
replace pt_ben1 = 0.8*earning	 		if country == "IS" & year == 2017 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19)

replace pt_ben1 = 1007	 				if country == "IS" & year == 2017 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 < 1007
										
replace pt_ben1 = 4257	 				if country == "IS" & year == 2017 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & inrange(whours,10,19) ///
										& pt_ben1 >= 4257
...
replace pt_ben1 = 1396	 				if country == "IS" & year == 2017 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & whours >= 20 ///
										& pt_ben1 < 1396
...
* the rest 
replace pt_ben1 = 609					if country == "IS" & year == 2017 & pt_eli == 1 ///
										& inlist(econ_status,1,2) & whours < 10
replace pt_ben1 = 609					if country == "IS" & year == 2017 & pt_eli == 1 ///
										& inlist(econ_status,3,4) 
										
* students
replace pt_ben1 = 1398					if country == "IS" & year == 2017 & pt_eli == 1 ///
										& pl031 == 6



replace pt_ben2 = pt_ben1 	if country == "IS" & year == 2017 & pt_eli == 1



foreach x in 1 2 {
	replace pt_ben`x' = 0 	if country == "IS" & year == 2017 & pt_eli == 0
}

replace pt_dur = 0 		if country == "IS" & year == 2017 & pt_eli == 0 
