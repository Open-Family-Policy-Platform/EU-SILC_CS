...
replace pl_eli = 1 			if country == "DE" & year == 2015 
replace pl_eli = 0 			if pl_eli == . & country == "DE" & year == 2015
...
/*	-> benefits are family entitlement (in couples assigned to women)
	...
	*/
replace pl_dur = 52 		if country == "DE" & year == 2015 & pl_eli == 1 ///
							& gender == 1 
replace pl_dur = 2*4.3 			if country == "DE" & year == 2015 & pl_eli == 1 ///
							& gender == 2 & pl_dur == .
...
* minimum
replace pl_ben1 = 300		if country == "DE" & year == 2015 & pl_eli == 1 ///
							& inrange(econ_status,1,2) & pl_ben1 < 300 

* ceiling
replace pl_ben1 = 1800		if country == "DE" & year == 2015 & pl_eli == 1 ///
...
replace pl_ben2 = pl_ben1 		if country == "DE" & year == 2015 & pl_eli == 1


foreach x in 1 2 {
	replace pl_ben`x' = 0 	if pl_eli == 0 & country == "DE" & year == 2015
}

replace pl_dur = 0 	if pl_eli == 0 & country == "DE" & year == 2015
