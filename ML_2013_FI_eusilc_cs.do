...
replace ml_ben1 = 22.13 * 21.7 		if country == "FI" & year == 2013 ///
									& gender == 1 & ml_eli == 1 ///
									& inlist(econ_status,1,2) & (earning*12) < 10189	
...
gen ml_ben56b = (earning - (54552/12)) * 0.325 		if country == "FI" & year == 2013 ///
													& gender == 1 ///
